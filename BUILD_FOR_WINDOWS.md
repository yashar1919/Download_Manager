...
3. **Build for Windows**
   ...
   This will create:
   - `dist/UVDM Setup 1.0.0.exe` - Full installer
   - `dist/UVDM-1.0.0-Portable.exe` - Portable executable (no installation needed!)

## Installation Options

### Option A: Use Portable Executable (Recommended)

1. Download `UVDM-1.0.0-Portable.exe`
2. Run it directly - **no installation required!**
3. Desktop shortcut will be created automatically

### Option B: Use Full Installer

1. Download `UVDM Setup 1.0.0.exe`
